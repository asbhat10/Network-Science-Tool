        ...
        if graph_string not in set_of_graphs:
            ...
            if len(input_connected_graph) > 0:
                ...
                if num_connected_components in i_point_dict:
                    i_point_dict[num_connected_components].append((merc_lat(eachIPoint.y), merc_lon(eachIPoint.x)))
                else:
                    i_point_dict[num_connected_components] = [(merc_lat(eachIPoint.y), merc_lon(eachIPoint.x))]
